...
cmd({
  ...
  if (action === 'on') {
    ...
    await m.reply("✅ *Anti-link enabled!* Links will now be auto-deleted ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴀʟɪ ᴍᴅ ʙᴏᴛ︎.");
  } 
  else if (action === 'off') {
    config.ANTI_LINK = 'false';
    await m.reply("❌ *Anti-link disabled!* Links are now allowed ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴀʟɪ ᴍᴅ ʙᴏᴛ︎︎.");
  } 
  else {
