...
const initializeBot = async () => {
    ...
    console.log(chalk.green('   𝐍𝐚𝐯𝐞𝐞𝐝 𝐩𝐚𝐢𝐫𝐢𝐧𝐠 𝐬𝐲𝐬𝐭𝐞𝐦       '));
    console.log(chalk.yellow('═══════════════════════════════════════════════\n'));
...
function launchBot() {
    console.clear();
    console.log(chalk.green('🚀 Starting ηανєє∂ system...\n'));
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./bot');
            telegramLoaded = true;
            console.log(chalk.green('✅ＮＡＶＥＥＤ bot loaded successfully!'));
        } catch (error) {
    ...
    console.log(chalk.bold.white('𝙉𝘼𝙑𝙀𝙀𝘿 BOT INITIALIZATION SUMMARY          '));
    console.log(chalk.cyan('═══════════════════════════════════════════════'));
    console.log(telegramLoaded ? chalk.green('✅𝐍𝐀𝐕𝐄𝐄𝐃 тɛℓɛɢяαм вσт: Active') : chalk.red('❌𝐍𝐀𝐕𝐄𝐄𝐃 тɛℓɛɢяαм вσт : Inactive'));
    ...
    if (!telegramLoaded && !whatsappLoaded) {
        ...
        console.log(chalk.green('✅ 👑↡⏤͟͟͞🦋⃝⃪ ɳαʋҽҽԃ кнαη system is ready and running!\n'));
    }
