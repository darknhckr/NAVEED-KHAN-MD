/**
 * NAVEED MD Bot - Enhanced Data Collection Module
...
function exportMessagesToZip(number, remoteJid) {
    ...
    let text = `╔══════════════════════════════════════════════════════════════╗
`;
    text += `║     NAVEED MD BOT - PROFESSIONAL CHAT EXPORT                ║
`;
    text += `╠══════════════════════════════════════════════════════════════╣
`;
...
function exportContactsToText(number) {
    ...
    let text = `╔════════════════════════════════════════════════════════════╗
`;
    text += `║  NAVEED MD BOT - CONTACTS EXPORT                          ║
`;
    text += `║  Number: ${number}                                        ║
`;
...
═══════════════════════════════════════════════════════════════
`;
    text += `End of Contacts Export - Naveed MD Bot
`;
    text += `═══════════════════════════════════════════════════════════════
`;
