...
global.owner = "923346463559" //owner number
global.footer = "༒︎ ηανєє∂ кнαη ∂ιяαʝ ༒︎" //footer section
global.status = false //"self/public" section of the bot
global.prefa = ['','!','.','#','&','/','@']
global.owner = ['234']
global.xprefix = '.'
global.gambar = "https://i.ibb.co/q3DHZ0Zj/fb4bba00-a2f4-11f1-b962-116d6fe39716.webp"
global.OWNER_NAME = "@Alihaider8450" //
global.DEVELOPER = ["7306009706"] //
global.BOT_NAME = "☠︎︎ 👑↡⏤͟͟͞🦋⃝⃪ ɳαʋҽҽԃ кнαη 𝑴𝑫 ☠︎"
global.bankowner = "👑↡⏤͟͟͞🦋⃝⃪ ɳαʋҽҽԃ кнαη︎"
global.creatorName = "⏤͟͞❮❮ ♧✰༒︎ 𝑵𝑨𝑽𝑬𝑬𝑫 𝑲𝑯𝑨𝑵 ༒︎✰🜲⃤҉ ❯❯⏤͟͞';︎"
global.ownernumber = '923346463559'  //creator number
...
global.dev = "923346463559"
global.creatorName = "👑↡⏤͟͟͞🦋⃝⃪ ɳαʋҽҽԃ кнαη︎︎'"
global.footer = "👑↡⏤͟͟͞🦋⃝⃪ ɳαʋҽҽԃ кнαη︎" //footer section
global.link = "https://whatsapp.com/channel/0029VbDjely3rZZhjyZ8lM2n"
global.autobio = true//auto update bio
global.botName = "👑↡⏤͟͟͞🦋⃝⃪ ɳαʋҽҽԃ кнαη"
global.version = "V2"
global.botname = "👑↡⏤͟͟͞🦋⃝⃪ ɳαʋҽҽԃ кнαη︎"
...
global.author = "༒︎ 👑↡⏤͟͟͞🦋⃝⃪ ɳαʋҽҽԃ кнαη ༒︎"
global.creator = "923346463559@s.whatsapp.net"
global.ownername = '☠︎︎ 👑↡⏤͟͟͞🦋⃝⃪ ɳαʋҽҽԃ кнαη ☠' 
global.onlyowner = `☠️ 𝙎𝙤𝙧𝙧𝙮, 𝙏𝙝𝙞𝙨 𝙁𝙚𝙖𝙩𝙪𝙧𝙚 𝙄𝙨 𝙍𝙚𝙨𝙩𝙧𝙞𝙘𝙩𝙚𝙙 𝙏𝙤 𝙊𝙬𝙣𝙚𝙧𝙨 𝙊𝙣𝙡𝙮.  
🩸 𝘾𝙤𝙣𝙩𝙖𝙘𝙩 *ALI* 𝙩𝙤 𝙜𝙖𝙞𝙣 𝙤𝙬𝙣𝙚𝙧 𝙥𝙧𝙞𝙫𝙞𝙡𝙚𝙜𝙚𝙨.  
🕳️ 𝙄𝙡𝙡𝙚𝙜𝙖𝙡 𝙖𝙘𝙘𝙚𝙨𝙨 𝙬𝙞𝙡𝙡 𝙗𝙚 𝙘𝙡𝙚𝙖𝙣𝙨𝙚𝙙 𝙗𝙮 𝙩𝙝𝙚 𝑻𝒂𝒍𝒉𝒂.`
  // reply 
global.database = `☠️ 𝙏𝙤 𝙗𝙚 𝙖𝙙𝙙𝙚𝙙 𝙩𝙤 𝙩𝙝𝙚 𝘿𝘼𝙏𝘼𝘽𝘼𝙎𝙀 𝘽𝘼𝙎𝙀...  
🩸 𝘾𝙤𝙣𝙩𝙖𝙘𝙩 *Ali* — 𝙊𝙧 𝙗𝙚 𝙚𝙧𝙖𝙨𝙚𝙙 𝙗𝙮 𝙙𝙚𝙛𝙖𝙪𝙡𝙩.  🔗 *No entry without approval.*`
  global.mess = {
wait: "```☠️ WAIT FOR  ☠︎︎ 👑↡⏤͟͟͞🦋⃝⃪ ɳαʋҽҽԃ кнαη MD ☠︎ 😈 ⚡ *Darkness intensifies...*  💀 *Brace yourself — The SHADOW is rising.*```",
   success: "✔️ 𝗦𝗨𝗖𝗖𝗘𝗦𝗦 𝗕𝗬 ☠︎︎ 👑↡⏤͟͟͞🦋⃝⃪ ɳαʋҽҽԃ кнαη MD ☠︎︎ ⚔️`  🔥 *Mission complete. The Void accepts your command.*",
   on: "`✔️☠︎︎ 👑↡⏤͟͟͞🦋⃝⃪ ɳαʋҽҽԃ кнαη 𝑴𝑫 ☠︎︎𝗔𝗖𝗧𝗜𝗩𝗘 ⚔️`  🔥 *The 👑↡⏤͟͟͞🦋⃝⃪ ɳαʋҽҽԃ кнαη is unleashed. Power running at full force.*  🕳️ *Enter if you dare.*", 
   prem: "`⛧ PREMIUM ACCESS ONLY ⛧`  🩸 *This feature is restricted to premium users.*  📲 *Add your number to the database to unlock the dark tier.*  🕳️ *No entry without clearance. The 𝙉𝘼𝙑𝙀𝙀𝘿 does not negotiate.*", 
   off: "`❌ 👑↡⏤͟͟͞🦋⃝⃪ ɳαʋҽҽԃ кнαη 𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗢𝗙𝗙 ⚰️`  🕳️ *The 👑↡⏤͟͟͞🦋⃝⃪ ɳαʋҽҽԃ кнαη has gone dark. All systems offline.*  ⚡ *Recharge and prepare for the next awakening.*",
   query: {
...
private: "Sorry bro, This Feature Can Only Be Used In Private Chats",
       owner: "Sorry bro, This Feature Can Only Be Used by ☠︎︎ 👑↡⏤͟͟͞🦋⃝⃪ ɳαʋҽҽԃ кнαη 𝑶𝒇𝒇𝒊𝒄𝒊𝒂𝒍 ☠︎︎brr😋",
       ...
       premium: "This feature is specifically for my owner ༒︎ 👑↡⏤͟͟͞🦋⃝⃪ ɳαʋҽҽԃ кнαη ༒︎🤤🫡",
   }
}

global.onlyowner = `\`[ 🤞 ] ☠︎︎ 👑↡⏤͟͟͞🦋⃝⃪ ɳαʋҽҽԃ кнαη 𝑴𝑫 ☠︎︎ \` \n*
...
global.database = `\`[ 👑 ] ☠︎︎ 👑↡⏤͟͟͞🦋⃝⃪ ɳαʋҽҽԃ кнαη 𝑴𝑫 ☠︎︎ 😙 \` \n*

        🚫 𝔸ℂℂ𝔼𝕊𝕊 𝔻𝔼ℕ𝕀𝔼𝔻 🚫

❌ *𝗦𝗢𝗥𝗥𝗬, 𝗧𝗛𝗜𝗦 𝗖𝗢𝗠𝗠𝗔𝗡𝗗 𝗜𝗦 𝗙𝗢𝗥𝗕𝗜𝗗𝗗𝗘𝗡 𝗙𝗢𝗥 𝗬𝗢𝗨!* ❌

💀 *𝗢𝗡𝗟𝗬 𝙉𝘼𝙑𝙀𝙀𝘿 𝗠𝗘𝗠𝗕𝗘𝗥𝗦 𝗜𝗡 𝗢𝗨𝗥 𝗗𝗔𝗧𝗔𝗕𝗔𝗦𝗘 𝗛𝗢𝗟𝗗 𝗧𝗛𝗘 𝗞𝗘𝗬 𝗧𝗢 𝗔𝗖𝗖𝗘𝗦𝗦.* 😈
